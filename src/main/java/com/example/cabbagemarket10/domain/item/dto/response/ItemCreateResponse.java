...
import com.example.cabbagemarket10.domain.item.domain.ConditionType;
import com.example.cabbagemarket10.domain.item.domain.Item;
import com.example.cabbagemarket10.domain.item.domain.TradeStatus;
import com.example.cabbagemarket10.domain.item.domain.TradeType;
